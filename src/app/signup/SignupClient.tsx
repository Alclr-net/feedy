          ...
          >
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <p className="text-[10px] text-muted-foreground/60 font-mono">
                Min 3 chars · lowercase letters &amp; numbers only
              </p>
            </div>
            ...
            <p className="text-center text-[11px] text-muted-foreground font-mono">
              ...
              <Link href="/signIn" className="text-foreground hover:text-muted-foreground underline underline-offset-2 transition-colors">
                Sign in
              </Link>
            </p>
          </form>
